...
/**
 *	\file       htdocs/custom/basket/docs/pdf_azurmention.module.php
 *	\ingroup    basket
 ...
 */
class pdf_azurmention extends ModelePDFPropales
{
	/**
	...
	public function __construct($db)
	{
		...
		// Translations
		$langs->loadLangs(array("main", "bills", "basket"));

		$this->db = $db;
		$this->name = "azurmention";
